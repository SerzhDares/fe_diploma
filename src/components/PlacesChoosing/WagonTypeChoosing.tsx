...
export const WagonTypeChoosing = () => {
  ...
  const activeWagonType = (e: any) => {
    ...
    const allWagonTypes = document.querySelectorAll('.ticket_wagon-type');
    allWagonTypes.forEach(type => {
        if (type.classList.contains('ticket_wagon-type_active')) {
            type.classList.remove('ticket_wagon-type_active');
        }
    })
    e.target.closest('.ticket_wagon-type').classList.add('ticket_wagon-type_active');
    setType(e.target.closest('.ticket_wagon-type').querySelector('.ticket_wagon-type_text').textContent);
  }
  ...
  return (
    ...
    <div className="wagon_type_choosing">
        ...
        <div className="wagon_types_container">
            <div className="ticket_wagon-type" onClick={activeWagonType}>
