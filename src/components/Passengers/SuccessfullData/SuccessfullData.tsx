...
export const SuccessfullData = () => {
  return (
    <div className="next-passenger_container success-passenger_data">
    <div className="data-ready_container">
      <div className="data-ready-icon_container">
      ...
      <span className="data-ready_text">Готово</span> 
    </div>
